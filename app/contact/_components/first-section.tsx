        ...
        <div className="md:w-1/3 font-medium px-10">
          ...
          <div
            className="
                    ...
                    "
          >
            Built for every team across your company, RGS Data-Platform boosts
          ...
          <div className="flex flex-col space-y-6 pb-20">
            ...
            <div className="flex gap-6 items-center">
              ...
              <div className="md:text-xl text-[#eff0ff] font-light">
                Visualize your insigt on your fingertips and increase your
                revenue
              </div>
            </div>
          ...
          >
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="text-md font-light text-[#6c6684] md:w-3/4 mb-1">
                I agree to RGS Technologie&apos;s Terms of Service and Privacy
                Policy.
              </div>
            </div>
