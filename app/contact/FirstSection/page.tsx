    ...
    <div className=" items-center justify-center flex flex-col px-20 m:px-0 py-20 space-y-10 text-center ">
      {!submitted ? (
        <div className="text-5xl ">
          <div className="text-5xl ">Talk with our team</div>

          <div className="text-xl mt-4">
            Fill out your information and a RGS Data Platform sales representative will
            contact you shortly.
          </div>
        </div>
      ) : (
                  ...
                  >
                    ...
                    <SelectContent>
                      <div className="flex gap-4">
                        <SelectItem value="canada"> India</SelectItem>
                      </div>
