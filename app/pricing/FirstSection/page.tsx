      ...
      <table className="shadow-md rounded max-w-5xl m-auto ">
        <thead className="sticky block top-0">
          <tr className="flex text-left ">
            <th
              scope="row"
              className=" hidden sm:block w-1/4 p-4 border bg-gray-100 border-r-0 rounded-tl border-gray-300"
            ></th>
            <th
              scope="col"
              className="w-1/3 sm:w-1/4 p-4 border bg-white border-r-0 border-gray-300 font-normal"
            >
            ...
            <th
              scope="col"
              className="w-1/3 sm:w-1/4 p-4 border bg-white rounded-tr border-gray-300 font-normal"
            >
        ...
        <tbody>
          <tr className="flex text-left">
            <th
              scope="row"
              className="w-1/4 p-4 bg-gray-100 border border-r-0 border-t-0 border-gray-300 hidden sm:block"
            ></th>
            <th
              scope="col"
              className="w-1/3 sm:w-1/4 p-4 border border-r-0 border-t-0 border-gray-300 flex flex-col"
            >
            ...
            <th
              scope="col"
              className="w-1/3 sm:w-1/4 p-4 border border-t-0 border-gray-300 flex flex-col"
            >
              <div className="flex items-center mb-4 flex-wrap sm:no-wrap justify-center sm:justify-start">
          ...
          <tr className="flex text-left text-sm flex-wrap sm:no-wrap ">
            <th
              scope="col"
              className="min-w-full sm:min-w-0 sm:w-1/4 p-4 bg-gray-100 border border-r-0  border-gray-300 font-normal flex items-center border-b-0 sm:border-b"
            >
              Web & email support
            </th>
            <td className="w-1/3 sm:w-1/4 p-4 border-gray-300 border border-r-0 flex items-center justify-center">
              Standard support
            </td>
            <td className="w-1/3 sm:w-1/4 p-4 border-gray-300 border border-r-0 flex items-center justify-center">
              Priority support
            </td>
            <td className="w-1/3 sm:w-1/4 p-4 border-gray-300 border flex items-center justify-center text-center">
          ...
          <tr className="flex text-left text-sm flex-wrap sm:no-wrap">
            <th
              scope="col"
              className="min-w-full sm:min-w-0 sm:w-1/4 bg-gray-100 p-4 border-gray-300 border border-r-0  border-t-0 font-normal"
            >
              Phone & video support
            </th>
            ...
            <td className="w-1/3 sm:w-1/4 p-4 border-gray-300 border border-t-0">
              <svg
                ...
                fill="none"
                stroke="currentColor"
                className="text-indigo-700 m-auto feather feather-check"
                stroke-width="2"
          ...
          <tr className="flex text-left text-sm flex-wrap sm:no-wrap ">
            <th
              scope="col"
              className="min-w-full sm:min-w-0 sm:w-1/4 p-4 border-gray-300 border border-r-0 border-t-0 bg-gray-100 font-normal"
            >
          ...
          <tr className="flex text-left text-sm flex-wrap sm:no-wrap">
            ...
            <td className="w-1/3 sm:w-1/4 p-4 border-gray-300 border border-r-0 border-t-0"></td>
            <td className="w-1/3 sm:w-1/4 p-4 border-gray-300 border border-r-0 border-t-0 text-center">
              SAML
            </td>
          ...
          <tr className="flex text-left text-sm flex-wrap sm:no-wrap">
            <th
              scope="col"
              className="min-w-full sm:min-w-0 sm:w-1/4 bg-gray-100 p-4 border-gray-300 border border-r-0  font-normal border-b-0 sm:border-b"
            >
          ...
          <tr className="flex text-left text-sm flex-wrap sm:no-wrap ">
            <th
              scope="col"
              className="min-w-full sm:min-w-0 sm:w-1/4 bg-gray-100 p-4 border-gray-300 border border-r-0 border-b-0 sm:border-b font-normal"
            >
              Logo and colour
            </th>
            <td className="w-1/3 sm:w-1/4 p-4 border-gray-300 border border-r-0 ">
        ...
        <tfoot>
          <tr className="flex text-left text-sm">
            ...
            <td className="w-1/3 sm:w-1/4 p-4 border-gray-300 border border-t-0 text-center">
              <a
                href=""
                className=" mt-auto block text-white bg-indigo-500 text-xs py-2 text-center rounded font-normal rounded-bt"
                title=""
              >
                Request a demo
              </a>
